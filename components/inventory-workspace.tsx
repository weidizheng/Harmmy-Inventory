...
export function InventoryWorkspace({ products }: Readonly<{ products: CatalogProduct[] }>) {
  ...
  const setAdjustment = (productId: string, unit: keyof InventoryAdjustment, value: number) => {
